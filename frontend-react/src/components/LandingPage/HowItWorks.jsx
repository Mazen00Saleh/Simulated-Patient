    ...
    <section id="how-it-works" className="section bg-light">
      <div className="container">
        ...
        <div className="timeline">
          <div className="timeline-item animate-on-scroll slide-up">
          ...
          <div className="timeline-item animate-on-scroll slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="timeline-item animate-on-scroll slide-up" style={{ animationDelay: '0.2s' }}>
